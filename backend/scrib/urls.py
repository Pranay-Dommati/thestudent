...
urlpatterns = [
    ...
    path('admin/external-client-payments/', views.AdminExternalClientPaymentListView.as_view(), name='admin-external-client-payments'),
    path('admin/external-client-payments/<int:pk>/', views.AdminExternalClientPaymentDetailView.as_view(), name='admin-external-client-payment-detail'),
