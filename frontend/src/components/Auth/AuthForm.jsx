...
export default function AuthForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 px-4 py-8">
      {/* Background elements */}
      ...
      <div className="relative w-full max-w-4xl bg-white shadow-2xl rounded-2xl overflow-hidden flex flex-col md:flex-row">
        {/* Left side panel - welcome section */}
        <div 
          className={`flex flex-col items-center justify-center p-6 sm:p-10 text-white w-full md:w-5/12 transition-all duration-500 bg-gradient-to-br ${
            isSignUp ? 'from-blue-600 to-indigo-700' : 'from-indigo-600 to-blue-700'
          }`}
        >
          ...
          <button 
            onClick={toggleForm}
            className="mt-2 px-6 py-2.5 border-2 border-white/80 text-white rounded-full hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
        ...
        <div className="flex w-full md:w-7/12 flex-col items-center justify-center px-6 sm:px-10 py-8 sm:py-12">
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="flex justify-center space-x-4">
              <button className="flex-1 p-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 hover:shadow-sm transition flex items-center justify-center">
