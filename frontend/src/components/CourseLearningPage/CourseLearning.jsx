  ...
  return (
    <div className="max-w-[1920px] mx-auto">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex-1 lg:mr-80 xl:mr-96 p-4 sm:p-6">
        ...
        {/* Course Content Sidebar - On the right */}
        <div className={`lg:w-80 xl:w-96 border-l border-gray-200 bg-white h-[calc(100vh-64px)] fixed lg:sticky top-16 right-0 z-30 transition-all duration-300 transform ${sidebarVisible ? 'translate-x-0' : 'translate-x-full'} lg:translate-x-0`}>
