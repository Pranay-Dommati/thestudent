    ...
    <section className="relative pt-24 pb-24 md:pt-32 md:pb-32 bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Simplified feature section - removed containers, changed text color */}
          {/* <div className="mt-20 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-12">
            <span className="text-indigo-600 font-bold text-lg">100% Free</span>
            <span className="text-indigo-600 font-bold text-lg">Structured Learning Paths</span>
            <span className="text-indigo-600 font-bold text-lg">AI-Powered Curation</span>
          </div> */}
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-auto">
          <path fill="#F9FAFB" fillOpacity="1" d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,138.7C672,149,768,203,864,202.7C960,203,1056,149,1152,138.7C1248,128,1344,160,1392,176L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
      </div>
    </section>
  );
