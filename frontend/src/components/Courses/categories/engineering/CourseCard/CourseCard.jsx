...
const categoryImages = {
  ...
  'AI': 'https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGFydGlmaWNpYWwlMjBpbnRlbGxpZ2VuY2V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
    ...
    return (
        <div className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 flex flex-col h-full border border-gray-100 relative">
            ...
            <div className="p-5 flex-grow flex flex-col">
                ...
                <Link to={`/courses/${id}`} className="group-hover:text-indigo-600 transition-colors duration-200">
