    ...
    <section className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
      ...
      <div className="border-t border-gray-100 pt-6 mb-6">
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-sm font-bold text-gray-700">Weekly Learning Goal</h3>
      ...
      <div className="border-t border-gray-100 pt-6">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-sm font-bold text-gray-700">Current Learning Streak</h3>
          <span className="text-sm bg-gradient-to-r from-amber-100 to-orange-100 text-amber-800 px-4 py-2 rounded-full flex items-center font-medium border border-amber-200">
