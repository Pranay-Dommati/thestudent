...
import { FaUserCircle, FaSignOutAlt, FaUserPlus, FaSignInAlt, FaHome } from 'react-icons/fa';
import { useAuth } from '../../context/AuthContext';
import LogoutConfirmModal from '../Common/LogoutConfirmModal';

/**
 * CoursesNavbar - Navbar specifically for the Courses frontend
 * Hides links to Code Visualizer, Course Creator, Admin, etc.
 * Only shows: Home (Courses), Courses, Learning Hub
 */
const CoursesNavbar = ({ initialStyle = "transparent" }) => {
    ...
    // Course selection page detection for styling
    const selectionMatchers = [
        /^\/(6th|7th|8th|9th|10th|11th|12th|engineering)\/?$/,
        /^\/(6th|7th|8th|9th|10th|11th|12th|engineering)\/cbse\/?$/,
        /^\/(6th|7th|8th|9th|10th|11th|12th|engineering)\/state\/?$/,
        /^\/(6th|7th|8th|9th|10th|11th|12th|engineering)\/state\/[^/]+\/?$/
    ];
                ...
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center">
                        ...
                        {isMobile ? (
                            ...
                            // Courses navigation - Including Course Creator
                            <div className="flex items-center justify-center flex-1 max-w-[600px]">
                                <div className="flex items-center space-x-8">
                        ...
                        <div className="flex items-center justify-end w-[200px]">
                            {loading ? (
                                <div className="hidden xl:flex items-center space-x-4">
                                    <div className={`h-10 w-20 rounded-full border ${isScrolled || initialStyle === 'light'
                                    ...
                                    <div className={`h-10 w-24 rounded-full ${isScrolled || initialStyle === 'light'
                    ...
                    ${isScrolled || initialStyle === 'light' || (isMobile && isCourseSelectionPage) ? 'text-blue-600 border border-blue-600 hover:bg-blue-50' : 'text-white border border-white hover:bg-white/10'}`}
                                    ...
                                    <Link
                                        ...
                                        className={`px-4 py-2 rounded-full font-medium transition-all duration-300 ${isScrolled || initialStyle === 'light' || (isMobile && isCourseSelectionPage)
                            ...
                            {loading ? (
                                <div className="xl:hidden ml-4 flex items-center">
                                    <div className={`w-8 h-8 rounded-full ${isScrolled || initialStyle === 'light'
                                ...
                                >
                                    <div className={`px-3 py-1.5 rounded-full ${isScrolled || initialStyle === 'light'
                                        ? 'bg-blue-600 text-white hover:bg-blue-700'
