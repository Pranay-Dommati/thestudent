...
export const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        if (isLoggedIn) {
            ...
            if (!sessionStorage.getItem('productRecorded')) {
                axiosInstance.post('/auth/record-product/', { product: 'codevisualizer' })
    ...
    const register = async (registrationData) => {
        try {
            const response = await axiosInstance.post('/auth/register/', { ...registrationData, signup_source: 'codevisualizer' });
