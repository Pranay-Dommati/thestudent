...
const ProfilePageDesktop = () => {
        ...
        if (field.type === 'select') {
            return (
                <select
                    ...
                    className={`w-full p-3 pl-4 border rounded-xl bg-white focus:ring-2 focus:outline-none transition-all shadow-sm ${error
        ...
        return (
            <div className="relative">
                ...
                <input
                    ...
                    value={value}
                    onChange={handleInputChange}
                    className={`w-full p-3 pl-12 border rounded-xl bg-white focus:ring-2 focus:outline-none transition-all shadow-sm ${error
                        ? 'border-red-300 focus:border-red-500 focus:ring-red-200'
                        : 'border-gray-300 focus:border-blue-500 focus:ring-blue-200'
                        }`}
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            ...
            {/* Logout Confirmation Modal (shared, via portal) */}
            <LogoutConfirmModal
