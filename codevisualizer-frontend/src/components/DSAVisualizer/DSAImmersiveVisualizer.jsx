            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                    {algorithmType === 'quick-sort' ? (
                        ...
                        <SearchRotatedArrayVisualizer customArray={customArray} code={code} onProgress={setProgress} seekRef={synthSeekRef} drawerState={drawerState} setDrawerState={setDrawerState} />
                    ) : algorithmType === 'fibonacci' ? (
                        <FibonacciVisualizer customArray={customArray} code={code} onProgress={setProgress} seekRef={synthSeekRef} drawerState={drawerState} setDrawerState={setDrawerState} />
