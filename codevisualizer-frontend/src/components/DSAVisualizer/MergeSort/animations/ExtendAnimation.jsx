...
const ExtendAnimation = ({ values, source, currentResult }) => {
        ...
        <div className="flex flex-col items-center gap-8 py-4 w-full max-w-4xl">
            ...
            <div className="relative flex flex-col items-center justify-center min-h-[200px] w-full">
                ...
                <div className="flex items-center gap-2 mb-12 flex-wrap justify-center">
                    ...
                    <div className="flex items-center gap-1 p-2 rounded-xl bg-purple-900/20 border border-purple-500/30 min-h-[60px] min-w-[100px] flex-wrap">
                        <span className="text-purple-500 font-mono text-2xl self-center">[</span>
                        ...
                        {/* The New Values dropping in sequentially */}
                        {values.map((val, idx) => (
                            <motion.div
                                key={`ext-${idx}`}
