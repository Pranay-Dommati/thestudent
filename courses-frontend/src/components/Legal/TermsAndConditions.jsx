...
const TermsAndConditions = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pt-16">
            ...
            <div className="bg-white shadow-sm sticky top-16 z-40 pointer-events-auto">
                <div className="max-w-4xl mx-auto px-4 py-3 md:py-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-y-2">
                        <FaFileContract className="text-blue-600 text-2xl md:text-3xl mr-3 sm:mr-4 self-start sm:self-center" />
