        ...
        try {
            ...
            if (response.data.success) {
                ...
                const formattedCourses = response.data.courses.map(enrollment => {
                    ...
                    // We standardize navigation to the generic ID-based learning route: /:courseId/learning
                    // Include courseId as query param to avoid late URL rewrite and cache key mismatch
                    const courseId = course.id;
                    const courseLearningUrl = `/${courseId}/learning?courseId=${courseId}`;
                                        ...
                                        <div className="space-y-0">
                                            ...
                                            <div>
                                                ...
                                                <div className="w-full bg-gray-100 rounded-full h-1.5">
                                                    <div
                                                        className={`rounded-full h-1.5 transition-all duration-300 ${course.progress < 30 ? 'bg-blue-500' :
