                                ...
                                <div className="flex items-center justify-between mb-8">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 mt-1">Guided learning paths based on your interests</p>
                                        </div>
                                    </div>
                                ...
                                <div className="group bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl p-5 text-white hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-semibold">Learn Smarter</h3>
                                                <p className="text-purple-100 text-xs">Get a guided learning path when you’re not sure where to start</p>
                                            </div>
                                        </div>
                                        <Link
                                            to="/learning-path"
