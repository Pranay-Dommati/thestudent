                            ...
                            <SegregatedCourseSections
                                ...
                                getLinkTo={(course) => {
                                    ...
                                    const basePath = selectedBoard.includes('state')
                                        ? `/9th/state/${stateId || selectedBoard.replace('state-', '')}/${sourceType}/${course.subject.toLowerCase()}`
                                        : `/9th/${selectedBoard}/${sourceType}/${course.subject.toLowerCase()}`;
