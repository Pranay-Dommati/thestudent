    ...
    return (
      ...
      `}} />
            ...
            <main ref={mainRef} className="bg-gradient-to-b from-gray-50 to-white">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            onClick={() => {
                                ...
                                const cameFromChat = referrer.includes('/learning-path') ||
                ...
                <nav
                    ref={navRef}
                    className={`bg-white border-b border-gray-200 px-1 py-2 z-40 shadow-sm lg:hidden transition-all duration-200 ${isNavSticky
                        ...
                        {tabs && tabs.length > 0 ? tabs.map((tab, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative px-1 py-3 rounded-lg transition-all duration-200 touch-manipulation ${isActive
                                ...
                                >
                                    <span className={`text-xs font-medium capitalize block leading-tight ${isActive ? 'font-semibold' : ''
                                        }`}>
                                        {tab.label}
                                    </span>
            ...
            <div className={`fixed inset-y-0 right-0 z-50 w-72 max-w-[85vw] bg-white/95 backdrop-blur-xl border-l border-gray-200/50 transform transition-all duration-300 ease-out ${showTopicsSidebar ? 'translate-x-0' : 'translate-x-full'
                }`}>
                {/* Clean Header */}
                ...
                <div className="flex-1 overflow-y-auto px-2">
                    {topicsList && topicsList.length > 0 ? topicsList.map((topic, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`group relative mb-1 rounded-lg overflow-hidden ${isActive ? 'bg-gradient-to-r from-blue-50 to-blue-100/50' : ''
                                    }`}
                            >
                                {/* Active Indicator */}
                                {isActive && (
                                ...
                                <div className="flex items-center px-3 py-3 gap-3">
                                    {/* Modern Number Badge */}
                                    <div className={`flex-shrink-0 relative flex items-center justify-center w-7 h-7 rounded-md text-xs font-medium transition-all ${isActive
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 min-w-0 text-left group-hover:opacity-90 transition-opacity ${isSelectingTopic ? 'opacity-50' : ''
                                            }`}
                                    >
                                        {/* Topic Title - Properly constrained */}
                                        <h4 className={`font-medium text-sm leading-tight truncate pr-2 ${isActive ? 'text-blue-900' : 'text-gray-800'
                                            }`}>
                                            {topic.name}
                                        </h4>
                                        {isActive && (
                                    ...
                                    >
                                        <span
                                            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-200 ${isCompleted
                    ...
                    <div className="border-t border-gray-100/80 px-4 py-4 bg-gray-50/30">
                        ...
                        <div className="relative">
                            <div className="w-full bg-gray-200/80 rounded-full h-1.5 overflow-hidden">
                                <div
                                    className={`h-1.5 rounded-full transition-all duration-700 ease-out ${completedTopics.length === topicsList.length
