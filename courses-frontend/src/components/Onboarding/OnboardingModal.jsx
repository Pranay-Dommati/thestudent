...
const OnboardingModal = () => {
    ...
    const handleStartCreating = (sampleText = null) => {
        ...
        setTimeout(() => {
            ...
            if (sampleText) {
                navigate('/learning-path', { state: { initialMessage: sampleText, forceProMode: true } });
            } else {
    ...
    return (
        <div
            className={`fixed inset-0 z-[9999] flex items-center justify-center p-4 transition-all duration-300 ${isAnimating ? 'bg-black/50 backdrop-blur-md' : 'bg-transparent'
                }`}
            role="dialog"
            aria-modal="true"
