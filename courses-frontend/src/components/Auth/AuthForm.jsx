...
export default function AuthForm() {
    ...
    // Redirect logged-in users to returnTo path or home
    useEffect(() => {
        if (isLoggedIn) {
            console.log('User is already logged in, redirecting...');
            navigate(returnToPath || '/', { replace: true });
        }
    }, [isLoggedIn, navigate, returnToPath]);
            ...
            <AnimatePresence>
                {isLoading && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm touch-none"
                                ...
                                >
                                            ...
                                            >
                                                <div>
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            className={`w-full p-4 pl-12 border-2 rounded-xl bg-gray-50 focus:ring-2 focus:outline-none transition-all text-base ${formErrors.name ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:ring-blue-200 focus:border-blue-500'
                                                                }`}
                                                            type="text"
                                                            name="name"
                                    ...
                                    <div>
                                        <div className="relative">
                                            ...
                                            <input
                                                className={`w-full p-4 pl-12 border-2 rounded-xl bg-gray-50 focus:ring-2 focus:outline-none transition-all text-base ${formErrors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:ring-blue-200 focus:border-blue-500'
                                                    }`}
                                                type="email"
                                                name="email"
                                    ...
                                    <div className="space-y-2">
                                        <div>
                                            <div className="relative">
                                                ...
                                                <input
                                                    className={`w-full p-4 pl-12 pr-4 border-2 rounded-xl bg-gray-50 focus:ring-2 focus:outline-none transition-all text-base ${formErrors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:ring-blue-200 focus:border-blue-500'
                                                        }`}
                                            ...
                                            >
                                                <div>
                                                    <div className="relative h-auto">
                                                        <div className="absolute left-0 top-1/2 -translate-y-1/2 pl-4 pointer-events-none text-gray-400 z-10">
                                                            <FaLock />
                                                        </div>
                                                        <input
                                                            className={`w-full p-4 pl-12 pr-4 border-2 rounded-xl bg-gray-50 focus:ring-2 focus:outline-none transition-all text-base ${formErrors.confirmPassword ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:ring-blue-200 focus:border-blue-500'
                                                                }`}
                                    ...
                                    >
                                                ...
                                                >
                                                    <div>
                                                        <div className="relative">
                                                            ...
                                                            <input
                                                                className={`w-full p-3 pl-10 border rounded-lg bg-gray-50 focus:ring-2 focus:outline-none transition-all ${formErrors.name ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100 focus:border-blue-500'
                                                                    }`}
                                                                type="text"
                                                                name="name"
                                                                placeholder="Full Name"
                                        ...
                                        <div>
                                            <div className="relative">
                                                ...
                                                <input
                                                    className={`w-full p-3 pl-10 border rounded-lg bg-gray-50 focus:ring-2 focus:outline-none transition-all ${formErrors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100 focus:border-blue-500'
                                                        }`}
                                                    type="email"
                                                    name="email"
                                                    placeholder="Email Address"
                                        ...
                                        <div>
                                            <div className="relative">
                                                ...
                                                <input
                                                    className={`w-full p-3 pl-10 pr-3 border rounded-lg bg-gray-50 focus:ring-2 focus:outline-none transition-all ${formErrors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100 focus:border-blue-500'
                                                        }`}
                                                    type={showPassword ? 'text' : 'password'}
                                                    name="password"
                                                    placeholder="Password"
                                        ...
                                        <AnimatePresence mode="wait">
                                            {isSignUp && (
                                                ...
                                                >
                                                    <div>
                                                        <div className="relative h-auto">
                                                            <div className="absolute left-0 top-1/2 -translate-y-1/2 pl-3 pointer-events-none text-gray-400 z-10">
                                                                <FaLock />
                                                            </div>
                                                            <input
                                                                className={`w-full p-3 pl-10 pr-3 border rounded-lg bg-gray-50 focus:ring-2 focus:outline-none transition-all ${formErrors.confirmPassword ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100 focus:border-blue-500'
                                                                    }`}
                                                                type={showConfirmPassword ? 'text' : 'password'}
                                                                name="confirmPassword"
                                                                placeholder="Confirm Password"
