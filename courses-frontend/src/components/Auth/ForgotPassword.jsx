                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full p-4 pl-12 border-2 rounded-xl bg-white focus:ring-2 focus:outline-none transition-all text-base ${formError ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:ring-blue-200 focus:border-blue-500'
                                    }`}
                                disabled={isLoading}
                            />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full p-4 pl-12 border-2 rounded-xl bg-gray-50 focus:ring-2 focus:outline-none transition-all text-base ${formError ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:ring-blue-200 focus:border-blue-500'
                                    }`}
                                disabled={isLoading}
                            />
                            {formError && <p className="text-red-500 text-sm mt-2">{formError}</p>}
