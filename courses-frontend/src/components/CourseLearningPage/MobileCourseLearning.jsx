            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-30 shadow-2xl backdrop-blur-sm bg-opacity-95">
                <div className="flex items-center justify-between gap-2 px-3 py-3 max-w-lg mx-auto">
                    <button
                        ...
                        className={`flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl font-semibold text-sm shadow-sm transition-all ${activeChapter === 0 && activeLesson === 0
                    ...
                    <button
                        ...
                        className={`flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl font-semibold text-sm shadow-sm transition-all ${activeChapter === course?.chapters.length - 1 && activeLesson === course?.chapters[activeChapter]?.lessons.length - 1
                                ? 'bg-gray-100 text-gray-400 cursor-not-allowed opacity-50'
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center flex-1 min-w-0">
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs mr-3 flex-shrink-0 ${chapter.lessons.every(l => l.completed)
                                        ...
                                        {expandedChapters[chapterIndex] && (
                                            ...
                                            >
                                                {chapter.lessons.map((lesson, lessonIndex) => (
                                                    <button
                                                        key={lessonIndex}
                                                        className={`w-full p-3 pl-4 flex items-center justify-between hover:bg-gray-100 transition-colors text-left group ${activeChapter === chapterIndex && activeLesson === lessonIndex
                                                    ...
                                                    >
                                                        <div className="flex items-center flex-1 min-w-0">
                                                            ...
                                                            <div
                                                                className={`mr-3 w-5 h-5 flex items-center justify-center rounded-full border-2 cursor-pointer select-none touch-manipulation active:scale-95 transition-all ${progressLoading
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                <h4 className={`text-sm font-medium truncate ${activeChapter === chapterIndex && activeLesson === lessonIndex
                                                                        ? 'text-indigo-700'
