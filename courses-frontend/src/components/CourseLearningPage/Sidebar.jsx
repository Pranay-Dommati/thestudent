...
const Sidebar = ({
    ...
    return (
        <div
            className={`w-full border-l border-gray-200 bg-white h-full overflow-hidden flex flex-col transform transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'
                }`}
        >
                        ...
                        <div className="mt-5">
                            ...
                            {(!certificate && progressPercent >= 100) && (
                                <button
                                    ...
                                    className={`group w-full relative overflow-hidden inline-flex items-center justify-center gap-2 px-4 py-3 rounded-md font-medium text-sm text-white transition focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 shadow ${issuingCert ? 'bg-indigo-400 cursor-not-allowed' : 'bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600'
                                        }`}
                                >
                        ...
                        >
                                ...
                                {expandedChapters[chapterIndex] && (
                                    ...
                                    >
                                        ...
                                        {chapter.lessons.map((lesson, lessonIndex) => (
                                            <div
                                                key={lessonIndex}
                                                className={`w-full p-3 pl-12 flex items-start text-left transition-colors duration-150 ${activeChapter === chapterIndex && activeLesson === lessonIndex
                          ...
                          `}
                                                        onClick={(e) => {
                                                            ...
                                                            if (lesson.isLocked) return; // don't allow when locked
