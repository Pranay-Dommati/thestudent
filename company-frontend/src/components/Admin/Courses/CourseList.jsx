    ...
    useEffect(() => {
        const fetchCourses = async () => {
            ...
            try {
                ...
                universalToast.error('Failed to load courses. Please try again.');
            } finally {
                setLoading(false);
            }
        };
        ...
        <div>
            ...
            <div className="px-4 py-5 sm:px-6">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                    {filters.type !== 'all' && (
                        <div className={`px-3 py-1.5 text-xs rounded-full flex items-center ${isDarkMode ? 'bg-blue-900/40 text-blue-300' : 'bg-blue-100 text-blue-800'}`}>
                            Type: {filters.type}
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex flex-wrap gap-2 mb-1">
                                            ...
                                            {course.category && (
                                                <span className={`px-2.5 py-0.5 text-xs rounded-full ${isDarkMode ? 'bg-blue-900/50 text-blue-300' : 'bg-blue-100 text-blue-800'
                                                    }`}>
                                                    {course.category}
                                                </span>
                                            )}
                                            ...
                                            {course.is_published ? (
                                                <span className={`px-2.5 py-0.5 text-xs rounded-full ${isDarkMode ? 'bg-green-900/50 text-green-300' : 'bg-green-100 text-green-800'
                                                    }`}>
                                                    Published
                                                </span>
                                            ) : (
                                                <span className={`px-2.5 py-0.5 text-xs rounded-full ${isDarkMode ? 'bg-red-900/50 text-red-300' : 'bg-red-100 text-red-800'
                                                    }`}>
                                                    Draft
                                                </span>
                                            )}
                                        ...
                                        <div className={`flex flex-wrap items-center gap-x-4 gap-y-1 mt-1.5 text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                            }`}>
